...
export const getSubcategoriesByCategoryId = async (categoryId: number): Promise<SubCategory[]> => {
  const response = await axios.get<SubCategory[]>(`/categories/${categoryId}/subcategories`);
  return response.data;
};
...
export const createSubCategory = async (
  ...
  const response = await axios.post<SubCategory>('/categories/subcategory', {
    categoryId,
    ...subCategoryData,
  });
  return response.data;
...
export const updateCategory = async (
  ...
  const response = await axios.patch<Category>(`/categories/${id}`, categoryData);
  return response.data;
};
