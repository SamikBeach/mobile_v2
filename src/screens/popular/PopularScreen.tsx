...
import { Category, SubCategory, HomeBookPreview } from '../../apis/book/types';
...
export const PopularScreen = () => {
  ...
  const {
    ...
    subcategoryId: selectedSubcategoryId === 0 ? undefined : selectedSubcategoryId,
    sort: sortOption,
    timeRange: timeRange,
  });
